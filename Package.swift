...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/dux-web/libghostty-spm/releases/download/storage.1.0.1782117075/GhosttyKit.xcframework.zip",
            checksum: "565bd4da5a939b7ff5c91bdf5f74a20f322b121c03e9b837f89067ad8f059302"
        ),
        .testTarget(
            name: "GhosttyKitTest",
