...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/dux-web/libghostty-spm/releases/download/storage.1.0.1780906089/GhosttyKit.xcframework.zip",
            checksum: "edfaedea087870cdff17607f9206fdb5382b3c133e5d0b04bfb28c7cc096846b"
        ),
        .testTarget(
            name: "GhosttyKitTest",
