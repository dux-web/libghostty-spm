...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/dux-web/libghostty-spm/releases/download/storage.1.0.1789390857/GhosttyKit.xcframework.zip",
            checksum: "cc9709dcd629b8fdd339b595e80ba363ebe68b8b226c6372faac426b7b7b1498"
        ),
        .testTarget(
            name: "GhosttyKitTest",
