...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/dux-web/libghostty-spm/releases/download/storage.1.0.1778485023/GhosttyKit.xcframework.zip",
            checksum: "c3cd3c4ba7d5191ae1e30e10b74de6273050d9cc2cdca4f0d10f6ae39cac899a"
        ),
        .testTarget(
            name: "GhosttyKitTest",
