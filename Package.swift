...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/dux-web/libghostty-spm/releases/download/storage.1.0.1785751730/GhosttyKit.xcframework.zip",
            checksum: "95ae82af3a65cb7c2baaf3e021bd7bd0a6fdfbf9bf8310dfba123e1a85e91e3d"
        ),
        .testTarget(
            name: "GhosttyKitTest",
