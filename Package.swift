...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/dux-web/libghostty-spm/releases/download/storage.1.0.1781512311/GhosttyKit.xcframework.zip",
            checksum: "71e3b848d0e9b3293a4fef32af5150afbd8a4040a05b0d3a79728b9d1c5760aa"
        ),
        .testTarget(
            name: "GhosttyKitTest",
