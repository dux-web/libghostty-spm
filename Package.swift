...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/dux-web/libghostty-spm/releases/download/storage.1.0.1786951613/GhosttyKit.xcframework.zip",
            checksum: "ec163e9ce7dbd21d16d6e4ee8007aaeb3f66c90845fcaeafe86179fa36298814"
        ),
        .testTarget(
            name: "GhosttyKitTest",
