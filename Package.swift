...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "libghostty",
            url: "https://github.com/dux-web/libghostty-spm/releases/download/storage.1.0.1782720589/GhosttyKit.xcframework.zip",
            checksum: "a46a32f0df9e9b38af8245d2fa59fa15adfb4bb64fcf87bcab6fffc89e5f663d"
        ),
        .testTarget(
            name: "GhosttyKitTest",
